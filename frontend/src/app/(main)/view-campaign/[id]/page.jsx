  ...
  return (
    <div>
        <div className="max-w-sm w-full lg:max-w-full my-10 grid grid-cols-12">
          <div
            className="col-span-4 h-48 lg:h-auto flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l ms-40 text-center overflow-hidden"
            ...
            title="Nike Shoes"
          ></div>
          <div className=" col-span-8 border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none me-10 lg:rounded-r p-4 flex flex-col justify-between leading-normal">
            <div className="mb-8">

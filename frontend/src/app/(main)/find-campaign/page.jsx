...
const FindCampaign = () => {
    ...
    return (
        <div>
            <>
            <header className='text-9xl text-center font-bold md:text-4xl md:leading-tight dark:text-white bg-slate-500 w-full border-spacing-8 p-5'>
                Find Campaigns
            </header>
                {/* Card Blog */}
                <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                    ...
                    <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                        ...
                        <p className="mt-0 text-gray-600 dark:text-gray-400 font-semibold">
